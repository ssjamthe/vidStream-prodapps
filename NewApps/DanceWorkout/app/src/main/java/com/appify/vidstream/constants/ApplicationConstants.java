...
public interface ApplicationConstants {
    ...
    String APP_ID = "24";                                                   // Change APP_ID = "2"    // U'll get .apk file from "Appify\app\build\outputs\apk\app_debug.apk"
    String APP_NAME = "Dance Workout";                                            // Change APP_NAME = ABC  // Also need to Change App Name From "app\res\values\strings.xml\app_name"
    ...
    String APP_PACKAGE = "com.appify.vidstream.app_24";                     // This required for IMEI // Change APP_PACKAGE = com.appify.vidstream.app_24  // Also need to Change Pkg Name at line no. 4 From "app\manifests\AndroidManifest.xml\package="com.appify.vidstream.app"" and Also from Gradle Scripts\build.gradle(Module: app)\applicationId "com.appify.vidstream.app"
    ...
    //TODO:- For Ads
    String ADMOB_BANNER = "ca-app-pub-5359662406012495/6914116160";         // Change AdMob Banner Id "ca-app-pub-9457891612292134/4990221400" also need to change from "app\res\values\strings.xml\banner_admob_ad_unit_id".
    String ADMOB_INTERSTITIAL = "ca-app-pub-5359662406012495/8390849360";   // Change AdMob Interstitial Id "ca-app-pub-9457891612292134/3629409406"
    long INMOBI_BANNER = 1484933378838L;                                    // Change InMobi Banner Id          // 1468657372594L banner  : need to write at the end of Id 'L' for long value
    long INMOBI_INTERSTITIAL =  1484645320220L;                              // Change InMobi Interstitial Id    // 1471704245580L interstitial : need to write at the end of Id 'L' for long value
