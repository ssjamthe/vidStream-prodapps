...
public interface ApplicationConstants {
    ...
    String APP_THEME_COLOR = "#a258f7";                                     // Change APP_THEME_COLOR for Alert messages Appify text color  // Also Need to change colors from "app\res\values\colors.xml"
    String APP_PACKAGE = "com.appify.vidstream.app_15";                     // This required for IMEI // Change APP_PACKAGE = com.appify.vidstream.app_14  // Also need to Change Pkg Name at line no. 4 From "app\manifests\AndroidManifest.xml\package="com.appify.vidstream.app"" and Also from Gradle Scripts\build.gradle(Module: app)\applicationId "com.appify.vidstream.app"
